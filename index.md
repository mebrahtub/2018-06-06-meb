...
venue: "Adigrat:Software carpentry workshop"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Mebrahtu","Mekonen"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Nega","hailu"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["barchu4@gmaul.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:   http://pad.software-carpentry.org/2018-06-06-meb          # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
